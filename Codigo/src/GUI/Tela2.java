...
public class Tela2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaCanais.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Recomendação médica", "Preço", "Quant. Unidades", "Descrição"
            }
        ) {
    ...
    private void pesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pesquisaKeyReleased
        ...
        try {
            ...
            cabecalho.add("id");
            cabecalho.add("nome");
            cabecalho.add("Recomendação médica");
            cabecalho.add("Preço");
            cabecalho.add("Quant. Unidades");
    ...
    private void ExcluirCanal() {
        ...
        objusuariodao.excluirCadastros(objmedsdto);
    }
     ...
     private void ListarValoresCanais() {
        try {
            ...
            ArrayList<medDTO> lista = objcanaisDAO.listarCanais();

            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    lista.get(num).getId(),
                    lista.get(num).getNome(),
                    lista.get(num).getRecomendacao(),
    ...
    private void EditarCadastro() {
        ...
        int id_canal;
        String recomendacao, nome, preco, quant, desc;
        ...
        recomendacao = (tabelaCanais.getModel().getValueAt(setar, 2).toString());
        preco = (tabelaCanais.getModel().getValueAt(setar, 3).toString());
        quant =(tabelaCanais.getModel().getValueAt(setar, 4).toString());
        desc = (tabelaCanais.getModel().getValueAt(setar, 5).toString());
        ...
        Tela4 tela4 = new Tela4 (objmedsdto);
